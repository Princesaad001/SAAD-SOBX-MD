...
const ownerNumber = ['923418595810']
...
*https://chat.whatsapp.com/F33ihm2AMymHbC3eTMwxBD*
...
*╰──────────────●●►*`;
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.postimg.cc/mgpqJBxG/IMG-20240429-212900.jpg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("HEY, SAAD-SOBX-MD STARTED ✅");
});
